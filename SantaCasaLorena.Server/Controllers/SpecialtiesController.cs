...
namespace SantaCasaLorena.Server.Controllers
{
    ...
    public class SpecialtiesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<SpecialtyResponseDto>> Create(SpecialtyRequestDto dto)
        {
        ...
        [HttpPut("{id:guid}")]
        public async Task<ActionResult<SpecialtyResponseDto>> Update(Guid id, SpecialtyRequestDto dto)
        {
