...
- Create Angular project with ng: `ng new santacasalorena.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`santacasalorena.client.esproj`).
